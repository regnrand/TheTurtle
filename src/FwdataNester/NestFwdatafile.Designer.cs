...
namespace FwdataTestApp
{
	partial class NestFwdataFile
	{
		...
		private void InitializeComponent()
		{
			...
			this._btnRunLoop = new Button();
			this._folderBrowserDialog = new FolderBrowserDialog();
			this._listView = new ListView();
			this.FwdataPathname = ((ColumnHeader)(new ColumnHeader()));
			this._btnToggle = new Button();
			this._cbFindDanglingRefs = new CheckBox();
			this.SuspendLayout();
			//
			// _btnBrowse
			//
			...
			this._btnBrowse.Click += new EventHandler(this.BrowseForFolder);
			//
			// _fwdataPathname
			//
			this._fwdataPathname.Enabled = false;
			this._fwdataPathname.Location = new Point(88, 12);
			this._fwdataPathname.Name = "_fwdataPathname";
			this._fwdataPathname.Size = new Size(385, 20);
			...
			this._btnRunSelected.Location = new Point(-1, 629);
			...
			this._cbNestFile.Location = new Point(-1, 403);
			...
			this._cbRoundTripData.Location = new Point(-1, 427);
			...
			this._cbVerify.Location = new Point(108, 427);
			...
			this._cbCheckOwnObjsur.Location = new Point(72, 405);
			...
			this._cbValidate.Location = new Point(214, 427);
			...
			this._rebuildDataFile.Location = new Point(-1, 487);
			...
			// _btnRestoreProjects
			//
			this._btnRestoreProjects.Location = new Point(430, 434);
			...
			// _btnClearCheckboxes
			//
			this._btnClearCheckboxes.Location = new Point(430, 403);
			...
			this._cbCheckAmbiguousElements.Location = new Point(17, 443);
			...
			// revisionBox
			//
			this.revisionBox.Location = new Point(62, 464);
			...
			this.revisionlabel.Location = new Point(-1, 467);
			...
			// _btnRunLoop
			//
			this._btnRunLoop.Location = new Point(140, 629);
			this._btnRunLoop.Name = "_btnRunLoop";
			this._btnRunLoop.Size = new Size(75, 23);
			this._btnRunLoop.TabIndex = 23;
			this._btnRunLoop.Text = "Run Loop";
			this._btnRunLoop.UseVisualStyleBackColor = true;
			this._btnRunLoop.Click += new EventHandler(this.RunLoopClicked);
			//
			...
			this.FwdataPathname});
			this._listView.Location = new Point(10, 79);
			this._listView.Name = "_listView";
			this._listView.Size = new Size(527, 318);
			...
			// _btnToggle
			//
			this._btnToggle.Location = new Point(13, 49);
			this._btnToggle.Name = "_btnToggle";
			this._btnToggle.Size = new Size(75, 23);
			this._btnToggle.TabIndex = 25;
			this._btnToggle.Text = "Toggle";
			this._btnToggle.UseVisualStyleBackColor = true;
			this._btnToggle.Click += new EventHandler(this.ToggleCheckBoxes);
			//
			// _cbFindDanglingRefs
			//
			this._cbFindDanglingRefs.AutoSize = true;
			this._cbFindDanglingRefs.Location = new Point(-1, 510);
			this._cbFindDanglingRefs.Name = "_cbFindDanglingRefs";
			this._cbFindDanglingRefs.Size = new Size(218, 17);
			...
			this.ClientSize = new Size(554, 657);
